...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function cache($minutes = 60)
        {
                        /** @var \Rimbaborne\Moota\Libraries\Moota $instance */
                        return $instance->cache($minutes);
        }
                    /**
         ...
         * @static 
         */ 
        public static function bank($bankId)
        {
                        /** @var \Rimbaborne\Moota\Libraries\Moota $instance */
                        return $instance->bank($bankId);
        }
                    /**
         ...
         * @static 
         */ 
        public static function mutation($bankId)
        {
                        /** @var \Rimbaborne\Moota\Libraries\Moota $instance */
                        return $instance->mutation($bankId);
        }
                    /**
...
namespace  { 
            ...
            class Moota extends \Rimbaborne\Moota\Facades\Moota {}
