        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    {{ __('backend_pembayarans.labels.management') }} <small class="text-muted">{{ __('backend_pembayarans.labels.active') }}</small>
                </h4>
            </div><!--col-->
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <th>@lang('backend_pembayarans.table.last_updated')</th>
                            <th>@lang('backend_pembayarans.table.actions')</th>
                        </tr>
                        </thead>
                        <tbody>
                        @foreach($pembayarans as $pembayaran)
                            <tr>
                                ...
                                <td class="align-middle">{{ $pembayaran->updated_at->diffForHumans() }}</td>
                                <td class="align-middle">{!! $pembayaran->action_buttons !!}</td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
