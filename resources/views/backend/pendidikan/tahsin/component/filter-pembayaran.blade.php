        ...
        <div class="row mt-2">
            ...
            <div class="col-3">
                ...
                <div class="input-group input-daterange">
                    <input type="text" class="form-control datepicker" name="start" value="{{ request()->start ? \Carbon\Carbon::parse(request()->start)->format('Y-m-d') : \Carbon\Carbon::now()->format('Y-m').'-01' }}">
                    <div style="padding-top: 2px">-</div>
                    <input type="text" class="form-control datepicker" name="end" value="{{ request()->end ? \Carbon\Carbon::parse(request()->end)->format('Y-m-d') : \Carbon\Carbon::now()->format('Y-m-d') }}">
                </div>
