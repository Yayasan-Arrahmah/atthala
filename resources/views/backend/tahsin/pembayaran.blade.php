...
<div class="card" style="min-width: 800px;">
    <div class="card-body">
        ...
        <div class="row mt-4">
            <div class="col">
                <div class="table-responsive px-4" style="min-width: 400px; ">
                    <section>
                        ...
                        <div class="row kotak">
                            ...
                            <div class="col">
                                <a href="/admin/tahsins/{{ $tahsin->id }}" style="color: rgb(56, 56, 56);">
                                    <div style="text-transform: uppercase;"><strong>{{ $tahsin->nama_peserta }}</strong> - {{ $tahsin->nohp_peserta }}</div>
                                    <div class="small text-muted">
                                        {{ $tahsin->level_peserta }} | {{ $tahsin->jadwal_tahsin }} <br>
                            ...
                            <div class="col">
                                <div class="text-center" style="padding-bottom: 5px">
                                    ...
                                    <div class="text-uppercase text-muted small">Pesan Terkirim</div>
                                </div>
                                    ...
                                    <div class="collapse" id="detail{{ $key + $tahsins->firstItem() }}" >
                                        ...
                                        @foreach($riwayatpembayaran as $riwayat)
                                            <div class="row">
                                                ...
                                                <div class="col-md-3"> {{ $riwayat->admin_pembayaran }} </div>
