            ...
            <div class="row mt-4 mb-4">
                <div class="col">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-2">
                            <input onkeyup="this.value = this.value.toUpperCase();" class="form-control" type="text" name="sudah_daftar_jadwal" placeholder="Isi Jika Status Sudah Daftar" maxlength="191" >
                        </div><!--col-->
                        <div class="col-md-2">
                            <input onkeyup="this.value = this.value.toUpperCase();" class="form-control" type="text" name="belum_daftar_jadwal" placeholder="Isi Jika Status Belum Daftar" maxlength="191" >
                        </div><!--col-->
                    </div>
                    <div class="form-group row">
                        <label class="col-md-2 form-control-label" >Keterangan </label>
                        <div class="col-md-10">
                            <input onkeyup="this.value = this.value.toUpperCase();" class="form-control" type="text" name="keterangan_jadwal" placeholder="Keterangan" maxlength="191" >
                        </div><!--col-->
                    </div>
                    <div class="form-group row">
                        <label class="col-md-2 form-control-label" >Perubahan dari Jadwal </label>
                        <div class="col-md-5">
                            <input onkeyup="this.value = this.value.toUpperCase();" class="form-control" type="text" name="pindahan_jadwal" placeholder="Diisi jika pindahan jadwal" maxlength="191" >
                        </div><!--col-->
                    </div>
                    <div class="form-group row">
                        <label class="col-md-2 form-control-label" >Keterangan Perubahan </label>
                        <div class="col-md-6">
                            <input onkeyup="this.value = this.value.toUpperCase();" class="form-control" type="text" name="pindahan_jadwal_2" placeholder="Diisi jika pindahan jadwal" maxlength="191" >
                        </div><!--col-->
                    </div>
                </div><!--col-->
            </div><!--row-->
