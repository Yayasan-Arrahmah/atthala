...
@section('title', __('backend_absens.labels.management') . ' | ' . __('backend_absens.labels.edit'))
...
@section('content')
{{ html()->modelForm($absen, 'PATCH', route('admin.absens.update', $absen->id))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">@lang('backend_absens.labels.edit')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
