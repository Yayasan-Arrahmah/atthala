        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    {{ __('backend_absens.labels.management') }} <small class="text-muted">{{ __('backend_absens.labels.deleted') }}</small>
                </h4>
            </div><!--col-->
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <th>@lang('backend_absens.table.deleted')</th>
                        ...
                        @foreach($absens as $absen)
                            <tr>
                                ...
                                <td class="align-middle">{{ $absen->deleted_at->diffForHumans() }}</td>
                                <td class="align-middle">{!! $absen->trashed_buttons !!}</td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
