        ...
        <div class="card">
            <center>
                ...
                <div style="padding-top: 0px">
                    <h4>Pendaftaran Calon Peserta Ujian Tahsin <br> Belum Dibuka</h4>
                                ...
                                <div class="table-responsive" style="padding: 0px 15px 15px 15px;">
                                    <section>
                                        ...
                                        <div class="row kotak">
                                            <div class="col-2">
                                                @php
                                                    $cekujian = DB::table('peserta_ujians')->where('no_tahsin', $tahsin->no_tahsin)->where('angkatan_ujian', session('daftar_ujian'))->first();
                                                @endphp
                                                @if (isset($cekujian))
