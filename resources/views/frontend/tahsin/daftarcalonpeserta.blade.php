...
@else
        ...
        <div class="col col-sm-5 align-self-center ">
            <div class="card pb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-4">
                                <a href="/tahsin/pendaftaran/print?id={{ $calonpeserta->no_tahsin }}"  style="color:white; font-size: 11px" class="btn btn-success">KARTU PENDAFTARAN</a>
                        </div>
                        <div class="col">
                        ...
                        <div class="col" style="margin-left: 0px;">
                            <div style="text-transform: uppercase;"><strong>{{ $calonpeserta->level_peserta }}</strong></div>
                            <div class="small text-muted">
    ...
    @else
        <form action="{{ route('frontend.tahsin.simpandaftarcalonpeserta') }}" onsubmit="return checkForm(this);" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row justify-content-center align-items-center">
                <div class="col col-sm-5 align-self-center">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-6">
                                    <input hidden name="id" type="text" value="{{ $calonpeserta->no_tahsin }}">
                            ...
                            <div class="form-group row">
                                <div class="col-5">
                                    <label class="form-control-label">Level Peserta</label>
                                </div>
                                <div class="col-7">
                            ...
                            <div class="form-group row">
                                <div class="col">
                                    <input oninvalid="setCustomValidity('Centang Terlebih Dahulu')" onchange="try{setCustomValidity('')}catch(e){}" id="setuju" type="checkbox" value="" required/> <label style="margin-bottom: 2px">Data yang dipilih sudah benar.</label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="form-group mb-0 clearfix">
                                        ...
                                        <button type="submit" class="btn btn-primary px-4 btn-block" style="background-color: rgb(83, 163, 28); border: rgb(83, 163, 28);"> Submit</button>
                                    </div><!--form-group-->
                                </div><!--col-->
                            </div><!--row-->
