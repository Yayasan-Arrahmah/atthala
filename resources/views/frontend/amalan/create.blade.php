...
@section('title', __('frontend_amalans.labels.management') . ' | ' . __('frontend_amalans.labels.create'))

@section('content')
{{ html()->form('POST', route('frontend.amalans.store'))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">@lang('frontend_amalans.labels.create')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
