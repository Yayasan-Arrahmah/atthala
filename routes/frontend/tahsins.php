...
Route::group(['prefix' => 'tahsin'], function () {
    ...
    Route::get('daftar-ulang-peserta-XX/cari',                  [TahsinController::class, 'caridaftarulangpeserta'])->name('tahsin.caridaftarulangpeserta');
    Route::get('daftar-ulang-peserta-XX/daftar',                [TahsinController::class, 'daftarulangpeserta'])->name('tahsin.daftarulangpeserta');
    Route::get('daftar-ulang-peserta-XX/daftar/datawaktu',      [TahsinController::class, 'daftarulangpesertadatawaktu'])->name('tahsin.daftarulangpesertadatawaktu');
    Route::get('daftar-ulang-peserta-XX/print',                 [TahsinController::class, 'printdaftarulangpeserta'])->name('tahsin.printdaftarulangpeserta');
    Route::post('daftar-ulang-peserta-XX/simpan',               [TahsinController::class, 'simpandaftarulangpeserta'])->name('tahsin.simpandaftarulangpeserta');
