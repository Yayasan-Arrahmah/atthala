...
Route::group(['prefix' => 'tahsin'], function () {
    ...
    Route::get('daftar-ulang-peserta-XIX/cari',                  [TahsinController::class, 'caridaftarulangpeserta'])->name('tahsin.caridaftarulangpeserta');
    Route::get('daftar-ulang-peserta-XIX/daftar',                [TahsinController::class, 'daftarulangpeserta'])->name('tahsin.daftarulangpeserta');
    Route::get('daftar-ulang-peserta-XIX/daftar/datawaktu',      [TahsinController::class, 'daftarulangpesertadatawaktu'])->name('tahsin.daftarulangpesertadatawaktu');
    Route::get('daftar-ulang-peserta-XIX/print',                 [TahsinController::class, 'printdaftarulangpeserta'])->name('tahsin.printdaftarulangpeserta');
    Route::post('daftar-ulang-peserta-XIX/simpan',               [TahsinController::class, 'simpandaftarulangpeserta'])->name('tahsin.simpandaftarulangpeserta');
