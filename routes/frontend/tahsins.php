...
Route::group(['prefix' => 'tahsin'], function () {
    ...
    Route::get('cek/daftar-ulang-peserta/cari',                 [TahsinController::class, 'caridaftarulangpeserta'])->name('tahsin.caridaftarulangpeserta');
    Route::get('cek/daftar-ulang-peserta/daftar',               [TahsinController::class, 'daftarulangpeserta'])->name('tahsin.daftarulangpeserta');
    Route::get('cek/daftar-ulang-peserta/daftar/datawaktu',     [TahsinController::class, 'daftarulangpesertadatawaktu'])->name('tahsin.daftarulangpesertadatawaktu');
    Route::get('cek/daftar-ulang-peserta/print',                [TahsinController::class, 'printdaftarulangpeserta'])->name('tahsin.printdaftarulangpeserta');
    Route::post('cek/daftar-ulang-peserta/simpan',               [TahsinController::class, 'simpandaftarulangpeserta'])->name('tahsin.simpandaftarulangpeserta');
