...
function(a) {
    ...
    }), a.fn.editableform.buttons = '', a.fn.editableform.errorGroupClass = "has-error", a.fn.editableform.errorBlockClass = null, a.fn.editableform.engine = "bs3"
// }), a.fn.editableform.buttons = '<button style="margin-top: 7px; padding: 0.06rem 0.25rem; margin-right: -5px;" type="submit" class="btn btn-info btn-sm editable-submit"><i class="fas fa-check"></i></button><button style="margin-top: 7px; padding: 0.06rem 0.35rem;" type="button" class="btn btn-outline-dark btn-sm editable-cancel"><i class="fas fa-times"></i></button>', a.fn.editableform.errorGroupClass = "has-error", a.fn.editableform.errorBlockClass = null, a.fn.editableform.engine = "bs3"
}(window.jQuery),
function(a) {
    "use strict";
